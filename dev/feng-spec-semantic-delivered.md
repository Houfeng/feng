...
- `spec` 的运行时值表示（独立草案：[feng-spec-codegen-delivered.md](./feng-spec-codegen-delivered.md) 与 [feng-value-model-delivered.md](./feng-value-model-delivered.md)）。
...
| [feng-spec-codegen-delivered.md](./feng-spec-codegen-delivered.md) | `spec` 值如何在 box 模型下落地（含 codegen / runtime） |
