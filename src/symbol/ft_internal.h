...
#define FENG_SYMBOL_FT_VERSION_MAJOR 0x02U
...
#define FENG_SYMBOL_FT_SEC_EXCEPTION_EFFECTS 0x000CU
...
#define FENG_SYMBOL_FT_SYM_FLAG_TUPLE_DECL 0x0040U
#define FENG_SYMBOL_FT_SYM_FLAG_SPEC_FORM_MASK 0x0180U
#define FENG_SYMBOL_FT_SYM_FLAG_SPEC_FORM_CALLABLE 0x0080U
#define FENG_SYMBOL_FT_SYM_FLAG_SPEC_FORM_UNION 0x0100U
#define FENG_SYMBOL_FT_SYM_FLAG_SPEC_FORM_INTERSECTION 0x0180U
#define FENG_SYMBOL_FT_SYM_FLAG_IS_VALUE 0x0200U
...
#define FENG_SYMBOL_FT_TYPE_KIND_SPEC_INTERSECTION 11U
...
/* Required FT 2.0 projection section; slots belong to the open declaration,
 * so equal or impossible closed instances never change their ordinals. */
typedef struct FengSymbolFtUnionProjectionRecord {
    uint32_t owner_symbol_id;
    uint32_t ordinal;
    uint32_t subject_type_id;
    uint32_t constraint_type_id;
    uint32_t path_start;
    uint32_t path_count;
