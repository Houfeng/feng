...
#undef FENG_DECLARE_KEYWORD_TOKEN
    ...
    FENG_TOKEN_SLASH,
    FENG_TOKEN_PERCENT,
    FENG_TOKEN_PLUS_ASSIGN,
    FENG_TOKEN_MINUS_ASSIGN,
    FENG_TOKEN_STAR_ASSIGN,
    FENG_TOKEN_SLASH_ASSIGN,
    FENG_TOKEN_PERCENT_ASSIGN,
    FENG_TOKEN_ASSIGN,
    FENG_TOKEN_NOT,
    FENG_TOKEN_LT,
    FENG_TOKEN_LE,
    ...
    FENG_TOKEN_OR_OR,
    FENG_TOKEN_AMP,
    FENG_TOKEN_AMP_ASSIGN,
    FENG_TOKEN_PIPE,
    FENG_TOKEN_PIPE_ASSIGN,
    FENG_TOKEN_CARET,
    FENG_TOKEN_CARET_ASSIGN,
    FENG_TOKEN_SHL,
    FENG_TOKEN_SHL_ASSIGN,
    FENG_TOKEN_SHR,
    FENG_TOKEN_SHR_ASSIGN,
    FENG_TOKEN_ARROW,
    FENG_TOKEN_TILDE,
    FENG_TOKEN_ELLIPSIS
} FengTokenKind;
