...
- [ ] 对 COMPOSITE01～COMPOSITE42 按各项语义的适用性核对正向／反向、声明／使用、同包／真实
...
COMPOSITE01～42 的复用／新增测试、断言、成本边界及最终回归结果集中记录于
...
- 状态：实施中（2026-09-08）；COMPOSITE01～COMPOSITE42 尚未验收。
...
- 问题：[G24 问题记录](./feng-language-conformance-coverage-hardening-issues/g24.md)，当前包含
  ISSUE-G24-001～ISSUE-G24-048。008 两处调用及 009 两条旧发码断言均仅按明确批准迁移。
