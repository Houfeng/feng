...
原有 COMPOSITE01～COMPOSITE06 保留编号并细化，新增 COMPOSITE07～COMPOSITE39。应区分四种
...
- [ ] 对 COMPOSITE01～COMPOSITE39 按各项语义的适用性核对正向／反向、声明／使用、同包／真实
...
- 状态：三个既有问题及复合 spec 泛型支持目标已批准，投影描述符承载与依赖归属已确认；
  COMPOSITE01～COMPOSITE39 待实施。整体开工尚有 §28.1.3 的准入、ABI／格式迁移和成本门槛
