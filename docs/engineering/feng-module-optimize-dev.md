...
- [x] 1.3 不在 `docs/specifications/feng-error-codes.md` 重复新增 AE0005。该文件在本任务实施时仍是
  滞后的旧总表，因此当时按人工决定只更新 AE 分段主规范；2026-09-10 旧总表已收敛为分类索引，
  当前及后续错误码定义仍只维护在 `docs/specifications/feng-error-codes-ae.md`。
