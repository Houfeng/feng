...
Feng — компилируемый язык программирования со статической типизацией, лаконичным синтаксисом, явными контрактами и автоматическим управлением памятью. Название происходит от китайского иероглифа «锋», означающего «острый».

Этот репозиторий, [Houfeng/feng](https://github.com/Houfeng/feng), является официальным репозиторием исходного кода языка программирования Feng. Официальный сайт — [feng-lang.com](https://feng-lang.com/).
